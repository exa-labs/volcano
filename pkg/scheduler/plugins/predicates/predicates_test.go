...
func TestInitPlugin(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			expectInPrefilter:       []string{nodeaffinity.Name, nodeports.Name, interpodaffinity.Name, podtopologyspread.Name},
			expectInReserve:         []string{},
			expectInPreBind:         []string{},
			expectInScore:           []string{},
		...
		},
		{
			...
			expectInStableFilter:    []string{nodeunschedulable.Name, nodeaffinity.Name, tainttoleration.Name},
			expectInPrefilter:       []string{nodeaffinity.Name, nodeports.Name, interpodaffinity.Name, podtopologyspread.Name, vbcap.Name, dynamicresources.Name},
